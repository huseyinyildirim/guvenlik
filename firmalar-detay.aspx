<%@ Page Language="C#" AutoEventWireup="true" CodeFile="firmalar-detay.aspx.cs" Inherits="personeller_detay" EnableEventValidation="False"  EnableViewState="false"%>
...
<tbody>
<tr>
<td class="tdb2"><h3><img src="images/ikon/folder-open.png" class="ikon" alt=""/> Firmalar > Detay</h3></td>
...
<td><asp:label id="bolge_id" runat="server" /></td>
</tr>
</tbody>
</table>
...
<td><asp:label id="faks" runat="server" /></td>
</tr>
<tr>
...
<td><asp:label id="vergi_dairesi" runat="server" /></td>
</tr>
<tr>
<td class="tdb">Vergi No</td>
<td><asp:label id="vergi_no" runat="server" /></td>
</tr>
<tr>
<td class="tdb">Ticaret Sicil No</td>
<td><asp:label id="ticaret_sicil_no" runat="server" /></td>
</tr>
<tr>
<td class="tdb">İl</td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personeller-guncelle.aspx.cs" Inherits="personeller_guncelle"  EnableEventValidation="false"%>
...
<!--SCRIPTS-->
<script type="text/javascript" src="js/personeller-guncelle.js"></script>
<!--SCRIPTS-->
...
<tbody>
<tr>
<td class="tdb2"><h3><img src="images/ikon/folder-open.png" class="ikon" alt=""/> Personeller > Güncelle</h3></td>
</tr>
</tbody>
</table>
...
<td><input type="text" id="tc_kimlik" name="tc_kimlik" maxlength="11" class="input" runat="server"/></td>
</tr>
<tr>
...
<tr>
<td class="tdb" rowspan="2">* Cinsiyet</td>
<td><asp:label id="cinsiyet_label" runat="server" /></td>
</tr>
<tr>
<td>
<table summary="" cellspacing="0" cellpadding="0" class="temiz">
...
<td>
<select id="cinsiyet" name="cinsiyet" class="input" disabled="disabled" runat="server">
...
<tr>
<td class="tdb" rowspan="2">Doğum Tarihi</td>
<td><asp:label id="dogum_tarihi_label" runat="server" /></td>
</tr>
<tr>
<td>
<table summary="" cellspacing="0" cellpadding="0" class="temiz">
...
<td>
<select id="dogum_tarihi_gun" name="dogum_tarihi_gun" class="input3" disabled="disabled" runat="server">
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<select id="dogum_tarihi_ay" name="dogum_tarihi_ay" class="input3" disabled="disabled" runat="server">
...
<select id="dogum_tarihi_yil" name="dogum_tarihi_yil" class="input3" disabled="disabled" runat="server">
<option>1930</option>
<option>1931</option>
<option>1932</option>
<option>1933</option>
...
<td><input type="text" id="dogum_yeri" name="dogum_yeri" maxlength="255" class="input" runat="server"/></td>
</tr>
<tr>
<td class="tdb">Ana Adı</td>
<td><input type="text" id="ana_adi" name="ana_adi" maxlength="255" class="input" runat="server"/></td>
</tr>
<tr>
<td class="tdb">Baba Adı</td>
<td><input type="text" id="baba_adi" name="baba_adi" maxlength="255" class="input" runat="server"/></td>
</tr>
<tr>
<td class="tdb">SSK No</td>
<td><input type="text" id="ssk_no" name="ssk_no" maxlength="13" class="input" runat="server"/></td>
</tr>
<tr>
<td class="tdb" rowspan="2">Eğitim Durumu</td>
<td><asp:label id="egitim_durumu_label" runat="server" /></td>
</tr>
<tr>
<td>
<table summary="" cellspacing="0" cellpadding="0" class="temiz">
...
<td>
<select id="egitim_durumu" name="egitim_durumu" class="input3" disabled="disabled" runat="server">
<option value="9">------ SEÇİNİZ ------</option>
...
<td><input type="text" id="ehliyet" name="ehliyet" maxlength="20" class="input" runat="server"/></td>
</tr>
<tr>
<td class="tdb" rowspan="2">* Güvenlik Eğitimi</td>
<td><asp:label runat="server" id="guvenlik_egitimi"/></td>
</tr>
<tr>
<td>
<table summary="" cellspacing="0" cellpadding="0" class="temiz">
<tbody>
<tr>
<td width="20"><input type="checkbox" class="alignmid" id="checkbox5" name="checkbox5"/></td>
<td>
<select id="sertifika_durumu" name="sertifika_durumu" class="input3" disabled="disabled" runat="server">
<option value="9">------ SEÇİNİZ ------</option>
...
<tbody>
<tr>
<td width="20"><input type="checkbox" class="alignmid" id="checkbox6" name="checkbox6"/></td>
<td>

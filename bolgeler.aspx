<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bolgeler.aspx.cs" Inherits="bolgeler" EnableEventValidation="False" %>
...
<asp:BoundField DataField="adi" HeaderText="Bölge Adı" SortExpression="adi"><HeaderStyle CssClass="tdb"/></asp:BoundField>

<asp:TemplateField HeaderText="Bağlı Şehirler"><HeaderStyle CssClass="tdb"/>
<ItemTemplate>
<asp:Label ID="il_kodlari" runat="server" Text='<%# Bind("il_kodlari") %>'></asp:Label>
</ItemTemplate>
</asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yoneticiler.aspx.cs" Inherits="yoneticiler" EnableEventValidation="False" %>
...
<asp:BoundField DataField="firma_id" HeaderText="Bağlı Olduğu Firma" SortExpression="firma_id"><HeaderStyle CssClass="tdb"/></asp:BoundField>
...
<asp:BoundField DataField="kullanici_adi" HeaderText="Kullanıcı Adı" SortExpression="kullanici_adi"><HeaderStyle CssClass="tdb"/></asp:BoundField>

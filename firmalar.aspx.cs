...
{
case "1":
SQL = "SELECT * FROM firma USE INDEX (id) WHERE id!='0' and id=" + Class.Degiskenler.AdminFirmaID + " LIMIT " + limit + "," + Class.Degiskenler.SayfalamaSayisi + "";
break;
...
default:
SQL = "SELECT * FROM firma USE INDEX (id) WHERE id!='0' LIMIT " + limit + "," + Class.Degiskenler.SayfalamaSayisi + "";
break;
}
...
{
case "1":
SQL = "SELECT * FROM firma USE INDEX (id) WHERE id!='0' and id=" + Class.Degiskenler.AdminFirmaID + "";
break;
...
default:
SQL = "SELECT COUNT(id) FROM firma USE INDEX (id) WHERE id!='0'";
break;
}
...
nc1.Text = "<h3><img src=\"images/ikon/folder-open.png\" class=\"ikon\" alt=\"\"/> Firmalar</h3>";
...
e.Row.Cells[4].Text = Class.Fonksiyonlar.TelFormatla(e.Row.Cells[4].Text);

e.Row.Cells[5].Text = Class.Fonksiyonlar.SiteFonksiyonlari.AdminAdSoyadVeTipVerID(e.Row.Cells[5].Text);
    
switch (e.Row.Cells[6].Text)
{
case "0":
e.Row.Cells[6].Text = "<b>Pasif</b>";
e.Row.Cells[9].Text = "<a href=\"?onay=ver&amp;id=" + ID + "\" id=\"firmalar_onay_ver_" + ID + "\"><img src=\"images/ikon/onayla2.png\" class=\"ikon\" alt=\"\"/></a>";
break;

case "1":
e.Row.Cells[6].Text = "Aktif";
e.Row.Cells[9].Text = "<a href=\"?onay=kaldir&amp;id=" + ID + "\" id=\"firmalar_onay_kaldir_" + ID + "\"><img src=\"images/ikon/onayla.png\" class=\"ikon\" alt=\"\"/></a>";
break;
}
 
e.Row.Cells[7].Text = "<a href=\"firmalar-detay.aspx?id=" + ID + "\" id=\"firmalar_detay_" + ID + "\"><img src=\"images/ikon/notes.png\" class=\"ikon\" alt=\"\"/></a>";
e.Row.Cells[8].Text = "<a href=\"firmalar-guncelle.aspx?id=" + ID + "\" id=\"firmalar_guncelle_" + ID + "\"><img src=\"images/ikon/guncelle.png\" class=\"ikon\" alt=\"\"/></a>";
}
...
string SQL = "UPDATE firma SET onay='" + deger + "' WHERE id='" + Class.Fonksiyonlar.SQLTemizle(Request.QueryString["id"]) + "' " + Class.Fonksiyonlar.SiteFonksiyonlari.AdminSQL() + "";

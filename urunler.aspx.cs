...
string SQL = "SELECT * FROM urun USE INDEX (id) LIMIT " + limit + "," + Class.Degiskenler.SayfalamaSayisi + "";
...
{
string SQL = "SELECT COUNT(id) FROM urun USE INDEX (id)";
...
nc1.Text = "<h3><img src=\"images/ikon/folder-open.png\" class=\"ikon\" alt=\"\"/> Ürünler</h3>";
...
e.Row.Cells[7].Text = "<a href=\"?onay=ver&amp;id=" + ID + "\" id=\"urunler_onay_ver_" + ID + "\"><img src=\"images/ikon/onayla2.png\" class=\"ikon\" alt=\"\"/></a>";
break;

case "1":
e.Row.Cells[5].Text = "Aktif";
e.Row.Cells[7].Text = "<a href=\"?onay=kaldir&amp;id=" + ID + "\" id=\"urunler_onay_kaldir_" + ID + "\"><img src=\"images/ikon/onayla.png\" class=\"ikon\" alt=\"\"/></a>";
break;
}
 
e.Row.Cells[6].Text = "<a href=\"urunler-guncelle.aspx?id=" + ID + "\" id=\"urunler_guncelle_" + ID + "\"><img src=\"images/ikon/guncelle.png\" class=\"ikon\" alt=\"\"/></a>";
}
...
string SQL = "UPDATE urun SET onay='" + deger + "' WHERE id='" + Class.Fonksiyonlar.SQLTemizle(Request.QueryString["id"]) + "'";
...
{
DataTable dt = ((DataSet)Cache["urun"]).Tables[0];

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bolgeler-ekle.aspx.cs" Inherits="bolgeler_ekle"  EnableEventValidation="false"%>
...
<!--SCRIPTS-->
<script type="text/javascript" src="js/bolgeler-ekle.js"></script>
<!--SCRIPTS-->
...
<tbody>
<tr>
<td class="tdb2"><h3><img src="images/ikon/folder-open.png" class="ikon" alt=""/> Bölgeler > Ekle</h3></td>
</tr>
</tbody>
</table>
...
<ItemTemplate>
<td style="padding:5px"><input name="il_kodlari" id="il_kodlari_<%# Eval("il_kodu") %>" type="checkbox" value="<%# Eval("il_kodu") %>" class="alignmid"/> <span class="alignmid"><%# Eval("il") %></span></td>
</ItemTemplate>

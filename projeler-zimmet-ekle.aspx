<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projeler-zimmet-ekle.aspx.cs" Inherits="projeler_zimmet_ekle"  EnableEventValidation="false"%>
...
<!--SCRIPTS-->
<script type="text/javascript" src="js/projeler-zimmet-ekle.js"></script>
<!--SCRIPTS-->
...
<div id="sari">
<img src="images/ikon/light.png" class="ikon" alt=""/> <span class="alignmid">Projeye eklemiş olduğunuz zimmetleri kaydet tuşuna bastıktan sonra sonra güncelleyemez veya silemezsiniz.</span>
</div>
...
<tbody>
<tr>
<td class="tdb2"><h3><img src="images/ikon/folder-open.png" class="ikon" alt=""/> Projeler > Ekle > Proje Zimmeti</h3></td>
<td class="tdb" align="center" width="10%"><p><img src="images/ikon/tag.png" class="ikon" alt=""/> <span class="alignmid" id="sp">ADIM 2</span></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td width="165" class="tdb" style="vertical-align:top">Proje Zimmeti Ekle</td>
<td>
...
<td width="120" style="padding:0 3px 0 3px"><input type="text" id="adet" name="adet" class="input" value="1"/></td>

...
string SQL = "SELECT * FROM personel USE INDEX (id) WHERE 1 " + Class.Fonksiyonlar.SiteFonksiyonlari.AdminSQL() + " LIMIT " + limit + "," + Class.Degiskenler.SayfalamaSayisi + "";
...
{
string SQL = "SELECT COUNT(id) FROM personel USE INDEX (id) WHERE 1 " + Class.Fonksiyonlar.SiteFonksiyonlari.AdminSQL() + "";
...
nc1.Text = "<h3><img src=\"images/ikon/folder-open.png\" class=\"ikon\" alt=\"\"/> Personeller</h3>";
...
{
case "0":
e.Row.Cells[6].Text = "Erkek";
break;

case "1":
e.Row.Cells[6].Text = "Bayan";
break;
}

e.Row.Cells[7].Text = Class.Fonksiyonlar.TelFormatla(e.Row.Cells[7].Text);

switch (e.Row.Cells[8].Text)
{
case "0":
e.Row.Cells[8].Text = "Silahsız";
break;

case "1":
e.Row.Cells[8].Text = "Silahlı";
break;
}

e.Row.Cells[9].Text = Class.Fonksiyonlar.SiteFonksiyonlari.AdminAdSoyadVeTipVerID(e.Row.Cells[9].Text);

switch (e.Row.Cells[10].Text)
{
case "0":
e.Row.Cells[10].Text = "<b>Pasif</b>";
e.Row.Cells[13].Text = "<a href=\"?onay=ver&amp;id=" + ID + "\" id=\"personel_onay_ver_" + ID + "\"><img src=\"images/ikon/onayla2.png\" class=\"ikon\" alt=\"\"/></a>";
break;

case "1":
e.Row.Cells[10].Text = "Aktif";
e.Row.Cells[13].Text = "<a href=\"?onay=kaldir&amp;id=" + ID + "\" id=\"personel_onay_kaldir_" + ID + "\"><img src=\"images/ikon/onayla.png\" class=\"ikon\" alt=\"\"/></a>";
break;
}

e.Row.Cells[11].Text = "<a href=\"personeller-detay.aspx?id=" + ID + "\" id=\"personel_detay_" + ID + "\"><img src=\"images/ikon/notes.png\" class=\"ikon\" alt=\"\"/></a>";
e.Row.Cells[12].Text = "<a href=\"personeller-guncelle.aspx?id=" + ID + "\" id=\"personel_guncelle_" + ID + "\"><img src=\"images/ikon/guncelle.png\" class=\"ikon\" alt=\"\"/></a>";
}
...
string SQL = "UPDATE personel SET onay='" + deger + "' WHERE id='" + Class.Fonksiyonlar.SQLTemizle(Request.QueryString["id"]) + "' " + Class.Fonksiyonlar.SiteFonksiyonlari.AdminSQL() + "";

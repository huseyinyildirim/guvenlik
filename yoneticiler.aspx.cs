...
string SQL = "SELECT * FROM admin USE INDEX (id) WHERE 1 " + Class.Fonksiyonlar.SiteFonksiyonlari.AdminSQL() + " LIMIT " + limit + "," + Class.Degiskenler.SayfalamaSayisi + "";
...
{
string SQL = "SELECT COUNT(id) FROM admin USE INDEX (id) WHERE 1 " + Class.Fonksiyonlar.SiteFonksiyonlari.AdminSQL() + "";
...
nc1.Text = "<h3><img src=\"images/ikon/folder-open.png\" class=\"ikon\" alt=\"\"/> Yöneticiler</h3>";
...
{
case "0":
e.Row.Cells[6].Text = "Genel Yönetici (Root)";
break;

case "1":
e.Row.Cells[6].Text = "Bölge Yöneticisi";
break;

case "2":
e.Row.Cells[6].Text = "Firma Yöneticisi";
break;

case "3":
e.Row.Cells[6].Text = "Genel Depo Yöneticisi";
break;

case "4":
e.Row.Cells[6].Text = "Firma Depo Yöneticisi";
break;
}
...
{
case "0":
e.Row.Cells[8].Text = "<b>Pasif</b>";
e.Row.Cells[10].Text = "<a href=\"?onay=ver&amp;id=" + ID + "\" id=\"yonetici_onay_ver_" + ID + "\"><img src=\"images/ikon/onayla2.png\" class=\"ikon\" alt=\"\"/></a>";
break;

case "1":
e.Row.Cells[8].Text = "Aktif";
if (ID != Class.Degiskenler.AdminID)
{
e.Row.Cells[10].Text = "<a href=\"?onay=kaldir&amp;id=" + ID + "\" id=\"yonetici_onay_kaldir_" + ID + "\"><img src=\"images/ikon/onayla.png\" class=\"ikon\" alt=\"\"/></a>";
}
else
{
...
e.Row.Cells[9].Text = "<a href=\"yoneticiler-guncelle.aspx?id=" + ID + "\" id=\"yonetici_detay_" + ID + "\"><img src=\"images/ikon/guncelle.png\" class=\"ikon\" alt=\"\"/></a>";
}
...
string SQL = "UPDATE admin SET onay='" + deger + "' WHERE id='" + Class.Fonksiyonlar.SQLTemizle(Request.QueryString["id"]) + "'";
...
{
DataTable dt = ((DataSet)Cache["admin"]).Tables[0];

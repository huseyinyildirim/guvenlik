<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projeler.aspx.cs" Inherits="projeler" EnableEventValidation="False" %>
...
<asp:BoundField DataField="firma_id" HeaderText="Firma" SortExpression="firma_id"><HeaderStyle CssClass="tdb"/></asp:BoundField>
<asp:BoundField DataField="baslangic" HeaderText="Başlangıç Tar." SortExpression="baslangic"><HeaderStyle CssClass="tdb"/></asp:BoundField>
<asp:BoundField DataField="bitis" HeaderText="Bitiş Tar." SortExpression="bitis"><HeaderStyle CssClass="tdb"/></asp:BoundField>
<asp:BoundField DataField="adi" HeaderText="Proje Adı" SortExpression="adi"><HeaderStyle CssClass="tdb"/></asp:BoundField>
<asp:BoundField DataField="yonetici_id" HeaderText="Proje Yöneticisi" SortExpression="yonetici_id"><HeaderStyle CssClass="tdb"/></asp:BoundField>
...
<asp:BoundField HeaderText="Ek."><HeaderStyle CssClass="tdb2" Width="1%"/></asp:BoundField>
